...
// メインプロンプト取得
$mainPrompt = file_get_contents("/var/www/html/tool/autoTweet/prompWordList/mainPrompt{$randomNumber}.csv");
...
// 置換処理
$mainPrompt = str_replace('--Theme--', $randomPrompt, $mainPrompt);
